...
func TestNewAddOutput_InitError(t *testing.T) {
	var patch = mock.Patches{T: t}.OsExit(func(int) {})
	var expectedHandle = "handle"
	var testExecutor = &stubAddExecutor{
