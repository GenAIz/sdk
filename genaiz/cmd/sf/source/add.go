...
func NewAddSource(factory AddExecutorFactory) *cobra.Command {
	var addCmd = &cobra.Command{
		...
		Short:   "Adds a data source to a Smart Function",
		Long:    "Adds a data source by full or partial qualified domain name and version to a Smart Function",
		Example: "genaiz sf data src add my-datasource:1.1.0 --oem=com.genaiz.dev",
