...
func NewRemoveSource(factory RemoveExecutorFactory) *cobra.Command {
	var rmCmd = &cobra.Command{
		...
		Short:   "Removes a data source from a Smart Function",
		Long:    "Removes a data source by full or partial qualified domain name and version from a Smart Function",
		Example: "genaiz sf data src rm my-datasource:1.1.0 --oem=com.genaiz.dev",
