Feature: data link outbound proxies
  ...
  Scenario: add portless data link proxy
    ...
    And the following parameters
      ...
      | $HOME/.config/genaiz/Genaiz.yaml | datalink-1 | com.genaiz.test | 1.0.0   | dev.genaiz.com |
  ...
  Scenario: add data link proxy
    ...
    And the following parameters
      ...
      | $HOME/.config/genaiz/Genaiz.yaml | datalink-1 | com.genaiz.test | 1.0.0   | *              |      |
      | $HOME/.config/genaiz/Genaiz.yaml | datalink-1 | com.genaiz.test | 1.0.0   | dev.genaiz.com | :443 |
  ...
  Scenario: remove invalid data link proxy
    ...
    And the following parameters
      | configFile                       | handle           | oem             | version | address        | port |
      | $HOME/.config/genaiz/Genaiz.yaml | datalink-invalid | com.genaiz.test | 1.0.0   | dev.genaiz.com | :443 |
