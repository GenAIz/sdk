Feature: data link sync
  ...
  Scenario: create data link locally
    Given the following parameters
      ...
      | my-project | my-project/Genaiz.yaml | datalink-1 | com.genaiz.test | 0.2.1   |
  ...
  Scenario: add data link double property
    ...
    And the following parameters
      ...
      | my-project | my-project/Genaiz.yaml | datalink-1 | com.genaiz.test | 0.2.1   | TEST_KEY | double | 13.0         |
  ...
  Scenario: publish data link
    ...
    And the following parameters
      ...
      | my-project | datalink-1 | com.genaiz.test | 0.2.1   |
  ...
  Scenario: synchronize data link to user configuration
    ...
    And the following parameters
      ...
      | $HOME/.config/genaiz/Genaiz.yaml | datalink-1 | com.genaiz.test | 0.2.1   | TEST_KEY |
  ...
  Scenario: edit data link double property
    ...
    And the following parameters
      ...
      | $HOME/.config/genaiz/Genaiz.yaml | datalink-1 | com.genaiz.test | 0.2.1   | TEST_KEY | 42.2         | DOUBLE |
  ...
  Scenario: publish data link new revision
    ...
    And the following parameters
      ...
      | datalink-1 | com.genaiz.test | 0.2.1   | 0.2.2      |
  ...
  Scenario: synchronize data link new revision to user configuration
    ...
    And the following parameters
      ...
      | $HOME/.config/genaiz/Genaiz.yaml | datalink-1 | com.genaiz.test | 0.2.2   | TEST_KEY | 0.2.1      |
    When I run the command "dk sync <oem>/<handle> --version=<version>"
    Then I should have a datalink under "<configFile>" named "<handle>", with handle "<handle>", oem "<oem>" and version "<version>"
    And I should have property under "<configFile>", for data link "<handle>", oem "<oem>" and version "<version>", with key "<key>"
  ...
  Scenario: synchronize unknown data link to user configuration
    ...
    And the following parameters
      ...
      | $HOME/.config/genaiz/Genaiz.yaml | unknown | com.genaiz.test | 1.0.0   |
