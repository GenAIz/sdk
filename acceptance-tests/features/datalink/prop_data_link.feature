Feature: data link properties
  ...
  Scenario: add data link property
    ...
    And the following parameters
      ...
      | $HOME/.config/genaiz/Genaiz.yaml | datalink-1 | com.genaiz.test | 1.0.0   | TEST_KEY | STRING |
  ...
  Scenario: edit data link property
    ...
    And the following parameters
      ...
      | $HOME/.config/genaiz/Genaiz.yaml | datalink-1 | com.genaiz.test | 1.0.0   | TEST_KEY | STRING | def_val      |
  ...
  Scenario: edit data link secret property invalid default value
    ...
    And the following parameters
      ...
      | $HOME/.config/genaiz/Genaiz.yaml | datalink-1 | com.genaiz.test | 1.0.0   | SECRET_KEY | invalid_value |
    When I run the command "dk prop edit <oem>/<handle>:<version> <key> --default-value=<defaultValue>"
  ...
  Scenario: edit data link secret property
    ...
    And the following parameters
      ...
      | $HOME/.config/genaiz/Genaiz.yaml | datalink-1 | com.genaiz.test | 1.0.0   | SECRET_KEY | name | description |
  ...
  Scenario: remove data link property
    ...
    And the following parameters
      ...
      | $HOME/.config/genaiz/Genaiz.yaml | datalink-1 | com.genaiz.test | 1.0.0   | TEST_KEY |
  ...
  Scenario: remove data link secret property
    ...
    And the following parameters
      | configFile                       | handle     | oem             | version | key        |
      | $HOME/.config/genaiz/Genaiz.yaml | datalink-1 | com.genaiz.test | 1.0.0   | SECRET_KEY |
    When I run the command "dk prop rm <oem>/<handle>:<version> <key>"
