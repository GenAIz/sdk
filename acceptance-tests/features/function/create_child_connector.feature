Feature: connector create for a parent solution
  ...
  Scenario: create parent solution
    Given the following parameters
      ...
      | parent-solution | com.genaiz.dev | solution-1 | solution description | My Solution | 0.1.1   | default workflow | default        | Default Workflow |
  ...
  Scenario: create child function
    ...
    And the following parameters
      ...
      | parent-solution | child-function | com.genaiz.dev | 0.1.1   | function | Dockerfile | .dockerignore |
  ...
  Scenario change child function type to connector
    ...
    And the following parameters
      ...
      | child-function | connector | com.genaiz.dev | 0.1.1   |
  ...
  Scenario: add data source to child function
    ...
    And the following parameters
      ...
      | child-function | datalink-1 | com.genaiz.dev | 1.0.0   | 0.1.1            | connector |
    And the workdir changes to "<folder>"
