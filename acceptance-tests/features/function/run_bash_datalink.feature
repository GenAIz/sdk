Feature: connector run with the bash example and a datalink
  ...
  Scenario: build bash example
    ...
    And the following parameters
      ...
      | run-bash-datalink | com.genaiz.dev/run-bash-datalink | latest  |
  ...
  Scenario: create datalink for bash example
    ...
    And the following parameters
      ...
      | run-bash-datalink | com.genaiz.dev | datalink-1 | 1.0.0   |
  ...
  Scenario: add prop spec for datalink
    ...
    And the following parameters
      ...
      | run-bash-datalink | com.genaiz.dev | datalink-1 | 1.0.0   | MY_KEY | test value   | STRING |
    And the workdir changes to "<path>"
  ...
  Scenario: add secret spec for datalink
    ...
    And the following parameters
      ...
      | run-bash-datalink | com.genaiz.dev | datalink-1 | 1.0.0   | SECRET_KEY |
    And the workdir changes to "<path>"
  ...
  Scenario: add data source for datalink
    ...
    And the following parameters
      ...
      | run-bash-datalink | ~/.config/genaiz/Genaiz.yaml | com.genaiz.dev | datalink-1 | 1.0.0   |
